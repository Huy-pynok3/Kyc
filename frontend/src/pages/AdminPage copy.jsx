...
export default function AdminPage() {
    ...
    useEffect(() => {
        const fetchSessions = async () => {
            const res = await axios.get(`${import.meta.env.VITE_API_BASE_URL}/api/kyc/sessions`,{
                headers: {
            ...
            <>
                <div className="min-h-screen flex items-center justify-center bg-gray-100">
                    <div className="bg-white p-6 rounded shadow">
                        ...
                        />
                        <button onClick={handleLogin} className="bg-indigo-600 text-white px-4 py-2 rounded w-full">
                            Đăng nhập
                        </button>
                    </div>
                </div>
        ...
        <div className="min-h-screen bg-gray-50 p-6">
            <div className="bg-white p-4 mb-6 rounded shadow space-y-2">
                ...
                <div className="flex gap-2">
                    ...
                    />
                    <button onClick={handleManualApprove} className="bg-green-600 text-white px-4 py-1 rounded">
                        Duyệt tay
                    </button>
                </div>
            </div>
            ...
            {loading ? (
                ...
                <table className="w-full bg-white shadow rounded overflow-x-auto">
                  ...
                  > */}
                                    ...
                                    <button
                                        onClick={() =>
                                            window.open(`https://bscscan.com/address/${item.wallet}`, "_blank")
                                        }
            ...
            <div className="min-h-screen bg-gray-100 p-4">
                <h1 className="text-xl font-bold mb-4 text-center">🧾 Danh sách phiên KYC</h1>
