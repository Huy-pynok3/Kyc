    ...
    <div className="relative" ref={menuRef}>
      ...
      {open && (
        <div className="absolute right-0 mt-2 w-40 bg-white shadow-lg rounded-lg overflow-hidden z-50">
          <button
            className="block w-full px-4 py-2 text-left text-gray-700 hover:bg-gray-100 focus:disabled:opacity-50 focus:outline-none focus:ring-2 focus:ring-blue-500"
          >
            🗝️ {studentId}
          </button>
          <button
